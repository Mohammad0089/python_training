...
class singlyLinkedList():
    ...
    def count_occurrence(self,data,node):
        if node:
            if node.data == data:
                return self.count_occurrence(data, node.next) + 1
            else:
                return self.count_occurrence(data, node.next)
        else:
            return 0

    def rotate(self, povit):
        # 4 5 6 4 7 8 8 8 9 povit is 7
        # 8 8 8 9 4 5 6 4 7 after rotate
        # find the node pre-povit and node pre-tail
        curr = self.head
        targetNode = None
        tail = None
        while curr:
        ...
        tail.next = self.head #end of the link will point to the head
        self.head = newHead
    ...
    def is_palindrome(self):
        ...
        data_str = ""
        while curr:
            data_str = data_str + str(curr.data)
            curr = curr.next
    ...
    def sum_two_lists(self, llist):
        ...
        while curr1 or curr2:
                ...
                if curr2:
                    n2 += str(curr2.data)
                    curr2 = curr2.next
        number_1 = int(n1[::-1] if n1 else "0")
        number_2 = int(n2[::-1] if n2 else "0")
...
l_3 = singlyLinkedList()
l_4 = singlyLinkedList()
...
l_4 = l_2.sum_two_lists(l_3)

print()
l_4.print_linkedList()
